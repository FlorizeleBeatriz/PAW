...
if (isset($_POST['doc_login'])) {
    ...
    if ($rs) { //if its sucessfull
        ...
        $err = "Acesso negado, tente novamente";
    }
}
?>
<!--End Login-->
                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Digite seu número de médico e senha para acessar o painel do médico.</p>
                            </div>
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="doc_number" type="text" id="emailaddress" required="" placeholder="Digite seu número de médico">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="password">Senha</label>
                                    <input class="form-control" name="doc_pwd" type="password" required="" id="password" placeholder="Digite sua senha">
                                </div>

                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-success btn-block" name="doc_login" type="submit">Entrar</button>
                                </div>
...
-->
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            ...
                            <!-- <p class="text-white-50">Não tem uma conta? <a href="his_admin_register.php" class="text-white ml-1"><b>Inscreva-se</b></a></p>-->
                        </div> <!-- end col -->
                    </div>
