...
<head>
    <meta charset="utf-8" />
    <title>Sistema de Informação de Gestão Hospitalar - Um Sistema de Informação Super Responsivo</title>
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted font-13">Você saiu com sucesso.</p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Voltar para <a href="index.php" class="text-white ml-1"><b>Entrar</b></a> OU <a href="../../index.php" class="text-white ml-1"><b>Página Inicial</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
