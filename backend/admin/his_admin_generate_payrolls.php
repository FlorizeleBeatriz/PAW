                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Gerar Folha de Pagamento</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Detalhes da Folha de Pagamento do Funcionário</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Data de Publicação</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_admin_generate_single_employee_payroll.php?pay_number=<?php echo $row->pay_number; ?>&&pay_doc_number=<?php echo $row->pay_doc_number; ?>" class="badge badge-success"><i class="fas fa-file-invoice-dollar "></i> Gerar Folha de Pagamento</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php $cnt = $cnt + 1;
