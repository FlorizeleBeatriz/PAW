                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <h3 class="mb-3"><b>Nome do Medicamento:</b> <?php echo $row->phar_name; ?></h3>
                                                <hr>
                                                <h4 class=""><b>Fornecedor do Medicamento:</b> <?php echo $row->phar_vendor; ?></h4>
                                                <hr>
                                                <h4 class=""><b>Quantidade do Medicamento:</b> <?php echo $row->phar_qty; ?> Cartelas</h4>
                                                <hr>
                                                <h4 class=""><b>Descrição do Medicamento</b></h4>
