                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Criar um Medicamento</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4" class="col-form-label">Quantidade do Medicamento (Cartelas)</label>
                                                <input required="required" type="number" name="phar_qty" class="form-control" id="inputPassword4">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputState" class="col-form-label">Categoria do Medicamento</label>
                                                <select id="inputState" required="required" name="phar_cat" class="form-control">
                                                    <!-- Buscar Todas as Categorias de Medicamentos -->
                                                    <?php
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputState" class="col-form-label">Fornecedor do Medicamento</label>
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword4" class="col-form-label">Código de Barras do Medicamento (EAN-8)</label>
                                            <?php
                                            $length = 10;
                                        ...
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Descrição do Medicamento</label>
                                            <input type="text" name="phar_desc" class="form-control">
                                        </div>
                                        <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Adicionar Medicamento</button>
                                    </form>
